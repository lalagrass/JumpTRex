 ...
 */
public class ItemTRex extends BaseItem {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.ducking && this.status != Status.CRASHED) {
            ...
            p.setStrokeWidth(2f);
            //canvas.drawRect(new Rect(this.xPos, this.yPos, config.WIDTH, config.HEIGHT), p);
            //canvas.drawRect(new Rect(0, 300, 600, 60), p);
