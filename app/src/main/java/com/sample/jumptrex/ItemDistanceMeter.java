...
/**
 * Created by ASUS on 7/23/2015.
 */
public class ItemDistanceMeter extends BaseItem {
    ...
    private void DrawNum(Canvas canvas, int digitPos, int value, boolean opt_highScore) {
        ...
        Rect sRect = getScaledSource(dimensions.WIDTH * value + spritePos.x, 0 + spritePos.y, dimensions.WIDTH, dimensions.HEIGHT);
        Rect tRect = getScaledTarget(dimensions.DEST_WIDTH * digitPos + deltaX, y + y, dimensions.WIDTH, dimensions.HEIGHT);
