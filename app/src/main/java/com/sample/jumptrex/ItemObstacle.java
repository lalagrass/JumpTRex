...
/**
 * Created by ASUS on 7/24/2015.
 */
public class ItemObstacle extends BaseItem {
    ...
    public ItemObstacle(types.ObstacleTypes type, Point dimensions, double gapCoefficient, double speed) {
        this.spritePos = type.spritePos;
        this.typeConfig = type;
        this.gapCoefficient = gapCoefficient;
        this.size = (int) getRandomNum(1, ItemObstacle.MAX_OBSTACLE_LENGTH);
    ...
    public double getGap(double gapCoefficient, double speed) {
        ...
        int maxGap = (int) Math.round(minGap * ItemObstacle.MAX_GAP_COEFFICIENT);
    ...
    public void update(Object... args) {
        ...
        if (!this.remove) {
            ...
            this.xPos -= Math.floor((speed * MySurfaceView.FPS / 1000) * deltaTime);
            // Update frame
